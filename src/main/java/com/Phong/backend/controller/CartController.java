...
public class CartController {
    ...
    @PostMapping("/add")
    public ApiResponse<Cart> addProductToCart(@RequestParam Long customerId,
    ...
    public ResponseEntity<ApiResponse<Cart>> updateProductQuantityInCart(
        ...
        ApiResponse<Cart> response = cartService.updateProductQuantityInCart(
                cartId, productId, updateQuantityRequest.getNewQuantity());
