...
public class AddressController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<AddressResponse>> addAddress(@RequestParam Long customerId,
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<AddressResponse>> patchAddress(@PathVariable Long id,
