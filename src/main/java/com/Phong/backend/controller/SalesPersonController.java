...
public class SalesPersonController {
    ...
    public ResponseEntity<ApiResponse<SellerResponse>> createPersonnel(@RequestBody SellerCreationRequest request) {
        ...
        return new ResponseEntity<>(ApiResponse.<SellerResponse>builder()
    ...
    public ResponseEntity<ApiResponse<List<SellerResponse>>> getAllPersonnel() {
        ...
        return new ResponseEntity<>(ApiResponse.<List<SellerResponse>>builder()
    ...
    public ResponseEntity<ApiResponse<SellerResponse>> getPersonnelById(@PathVariable Long id) {
        return service.getPersonnelById(id)
                .map(personnel -> new ResponseEntity<>(ApiResponse.<SellerResponse>builder()
                        .message("Personnel fetched successfully")
                        .result(personnel)
                        .build(), HttpStatus.OK))
                .orElseGet(() -> new ResponseEntity<>(ApiResponse.<SellerResponse>builder()
                        .message("Personnel not found")
                        .build(), HttpStatus.NOT_FOUND));
    }

    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<SellerResponse>> updatePersonnel(@PathVariable Long id, @RequestBody SellerUpdateRequest request) {
